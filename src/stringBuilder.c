...
void stringBuilder_printColorChart(void){
	...
	STRING_BUILDER_INIT_TEXT_MODIFIER(DARK_ORANGE);
	...
	STRING_BUILDER_INIT_TEXT_MODIFIER(FOREST_GREEN);
	stringBuilder_appendColor(&b, FOREST_GREEN, "FOREST_GREEN\n");

	STRING_BUILDER_INIT_TEXT_MODIFIER(LIME);
	...
	STRING_BUILDER_INIT_TEXT_MODIFIER(FLORAL_WHITE);
	stringBuilder_appendColor(&b, FLORAL_WHITE, "FLORAL_WHITE\n");

	STRING_BUILDER_INIT_TEXT_MODIFIER(ALICE_BLUE);
	stringBuilder_appendColor(&b, ALICE_BLUE, "ALICE_BLUE\n");

	STRING_BUILDER_INIT_TEXT_MODIFIER(GHOST_WHITE);
	stringBuilder_appendColor(&b, GHOST_WHITE, "GHOST_WHITE\n");

	STRING_BUILDER_INIT_TEXT_MODIFIER(HONEYDEW);
	stringBuilder_appendColor(&b, HONEYDEW, "HONEYDEW\n");

	STRING_BUILDER_INIT_TEXT_MODIFIER(IVORY);
	stringBuilder_appendColor(&b, IVORY, "IVORY\n");

	STRING_BUILDER_INIT_TEXT_MODIFIER(AZURE);
	stringBuilder_appendColor(&b, AZURE, "AZURE\n");

	STRING_BUILDER_INIT_TEXT_MODIFIER(SNOW);
	stringBuilder_appendColor(&b, SNOW, "SNOW\n");

	STRING_BUILDER_INIT_TEXT_MODIFIER(BLACK);
	stringBuilder_appendColor(&b, BLACK, "BLACK\n");

	STRING_BUILDER_INIT_TEXT_MODIFIER(DIM_GRAY);
	stringBuilder_appendColor(&b, DIM_GRAY, "DIM_GRAY\n");

	STRING_BUILDER_INIT_TEXT_MODIFIER(GRAY);
	stringBuilder_appendColor(&b, GRAY, "GRAY\n");

	STRING_BUILDER_INIT_TEXT_MODIFIER(DARK_GRAY);
	stringBuilder_appendColor(&b, DARK_GRAY, "DARK_GRAY\n");

	STRING_BUILDER_INIT_TEXT_MODIFIER(SILVER);
	...
	STRING_BUILDER_INIT_TEXT_MODIFIER(GAINSBORO);
	stringBuilder_appendColor(&b, GAINSBORO, "GAINSBORO\n");

	STRING_BUILDER_INIT_TEXT_MODIFIER(WHITE_SMOKE);
	stringBuilder_appendColor(&b, WHITE_SMOKE, "WHITE_SMOKE\n");

	STRING_BUILDER_INIT_TEXT_MODIFIER(WHITE);
