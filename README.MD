...
When running a **debug** build, debug information will be logged using **syslog** use **journalctl** or any other method supported by your distribution to see log messages, to access herders debug information.